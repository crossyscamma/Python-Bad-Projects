#můj zatím největší projekt v pythonu
...
def equalpress():
    try:
        ...
        equation.set("Unexpected problem",)
        expression = "" 
...
menubar.add_cascade(label = "Calculators", menu=filemenu)
filemenu.add_command(label = "Classic", command = klasicka)
filemenu.add_command(label = "Advanced", command = rozsirena)
