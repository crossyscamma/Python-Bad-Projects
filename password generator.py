...
class GUI():
    ...
    def __init__(self,master):
        ...
        master.title('Password Generator by HOUMR')
        master.geometry('840x500')
        
        master.resizable(False, False)

        self.label=Label(text="Password Generator",fg='darkmagenta',font='Arial 35 underline bold')
        ...
        self.user=Label(text="Username:",font='Arial 25 bold')
        ...
        self.length=Label(text="Length of password:",font='Arial 25 bold')
        ...
        self.generated_password=Label(text="Generated Password:",font='Arial 25 bold')
